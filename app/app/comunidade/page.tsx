...
const tipoConfig: Record<string, { label: string; color: string; bg: string }> = {
  vitrine: { label: "Vitrine", color: "#1B3D2A", bg: "#1B3D2A15" },
  dica: { label: "Boa prática", color: "#7A8B6F", bg: "#7A8B6F15" },
  venda: { label: "História", color: "#A47864", bg: "#A4786415" },
  duvida: { label: "Dúvida", color: "#1F5C63", bg: "#1F5C6315" },
};
...
export default function ComunidadePage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="font-serif text-2xl font-semibold text-ink">Comunidade Casa Marken Fassi</h1>
      ...
      {showComposer && (
        <div className="card-fassi p-4 animate-fade-in">
          <div className="flex gap-3">
            <div className="w-10 h-10 rounded-full bg-brand/10 flex items-center justify-center text-xs font-bold text-brand flex-shrink-0">
              ...
              <div className="flex items-center gap-5 text-sm">
                <button
                  ...
                  className={cn(
                    ...
                    curtido ? "text-brand" : "text-muted hover:text-brand"
                  )}
                >
